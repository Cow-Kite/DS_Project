...
class GraphSAGE(torch.nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = SAGEConv(dataset.num_node_features, 16, aggr='mean')
        self.conv2 = SAGEConv(16, dataset.num_classes, aggr='mean')
...
def train_node_classifier(model, graph, optimizer, criterion, n_epochs=180):
    # 에폭 횟수만큼 학습 반복
